...
form#loginform input[type=password], form#loginform input[type=text] {
  ...
  <link rel='stylesheet' id='bootstrap-css' href='../content/themes/streamit-theme/assets/css/vendor/bootstrap.min.css' type='text/css' media='all' />
   ...
   <meta name='setting_options' data-version='3.4.3' data-path='https://resources/content/themes/streamit-theme/assets/css/vendor/'></meta> <noscript><style>.woocommerce-product-gallery{ opacity: 1 !important; }</style></noscript>
...
<div id="page" class="site streamit">
   ...
   <div class="site-content-contain">
       <div id="content" class="site-content">
                 ...
                 <div class="elementor-section elementor-top-section elementor-element elementor-element-5b7eb3f elementor-section-full_width elementor-section-height-min-height elementor-section-stretched elementor-section-content-middle elementor-section-height-default elementor-section-items-middle" data-id="5b7eb3f" data-element_type="section" data-settings="{&quot;stretch_section&quot;:&quot;section-stretched&quot;,&quot;background_background&quot;:&quot;classic&quot;}" style="width: 100%;height: 100%; left: 0px;">
     ...
     <form name="loginform" id="loginform" action="{{route('login')}}" method="post"><a class="logo-link" href="../pages/index.html"><img decoding="async" class="img-fluid logo" src="../content/themes/streamit-theme/assets/images/logo.png" alt="wp-rig"></a><input type="hidden" name="pmpro_login_form_used" value="1"><p class="login-username">
...
<div id="woof_html_buffer" class="woof_info_popup" style="display: none;"></div></body></html>