            ...
            <div class="box-1 bg-light user">
                ...
                <div class="box-inner-1 pb-3 mb-3">
                    ...
                    <div class="text-primary title genres">
                        <b style="color:black !important">Genres</b> <span class="text-body"><span class="text-body" style="color:red !important">Sci-Fi</span>
                        </span>
                    </div>

                    <div class="text-primary title tag">
                        <b style="color:black !important">Tags</b> <span class="text-body"><span class="text-body" style="color:red !important">Action</span>, <span class="text-body" style="color:red !important">Assassin</span>,
                       <span class="text-body" style="color:red !important">Thriller</span></span>
                    </div>
                </div>
                <b style="color:black">About Movie</b>
                <p style="color:red">Watch the preview of Twisters for free. The full film "Twisters" is available to buy or rent now.
                </p>
            ...
            <div class="box-2">
                <div class="box-inner-2">
                    <div>
                        ...
                        <p class="dis mb-3 text-danger fw-bold">You can rent this movie for 30 days but will have 2 days to watch it once you start playback</p>
                    </div>
                    <p><b style="color:black">
                    Streaming supported on mobile, website, Android TV, Apple TV, and Fire TV. Plays on compatible devices
By continuing, I agree to  Terms and Conditions and express my consent to complete the transaction.</b>
    </p>    
    <br>
                            <div class="address">
