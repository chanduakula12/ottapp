...
<html lang="en-US" class="no-js">
  ...
  <body class="page-template page-template-elementor_header_footer page page-id-19238 wp-embed-responsive overflow-hidden iq-container-width theme-streamit-theme masvideos-no-js pmpro-body-has-access woocommerce-no-js has-sidebar css_prefix-custom-header elementor-default elementor-template-full-width elementor-kit-6 elementor-page elementor-page-19238 css_prefix-banner-hide">
    <div id="page" class="site streamit"><a class="skip-link screen-reader-text" href="#primary">Skip to content</a>
      ...
      <div class="site-content-contain">
        <!-- success message --> @if(session()->has('message')) <div class="alert alert-success">
          {{ session()->get('message') }}
        </div> @endif
        <!-- success message -->
                      ...
                      <div class="elementor-widget-container">
                        <div id="home" class="iq-main-slider p-0 iq-rtl-direction iq-home-banner-slider iqonic-lazy-load-images">
                          <div id="home-slider-77" data-rand="home-slider-77" class="home-slider slider m-0 p-0" data-nav="true" data-autoplay="true" data-infinite="true" data-speed="500" data-autoplay-speed="5000">
                            <!--start carousel --> @foreach($bannerimages as $images)
                            <?//php dd($images); ?>
                            <div class="slide slick-bg movie  iqonic-lazy" style="background:url('../content/plugins/streamit-extensions/includes/Elementor/assets/img/placeholder_genre.jpg')" data-srcset="{{ asset($images->bannerimages->banner_image) }}">
                                    ...
                                    <div class="col-lg-7 col-md-12">
                                      ...
                                      <div class="d-flex flex-wrap align-items-center RightAnimate-two movie-meta">
                                        <div class="slider-ratting d-flex align-items-center ml-0 mt-0">
                                          <!-- <ul class="ratting-start p-0 m-0 list-inline text-primary d-flex align-items-center justify-content-left"><li><i class="fas fa-star" aria-hidden="true"></i></li><li><i class="fas fa-star" aria-hidden="true"></i></li><li><i class="fas fa-star" aria-hidden="true"></i></li><li><i class="fas fa-star" aria-hidden="true"></i></li><li><i class="fas fa-star-half" aria-hidden="true"></i></li></ul> -->
                                          <!-- <span class="rating-text ml-2">
                                                                        4.7                </span> -->
                                          <!-- <span class="imdb-logo ml-2"><img decoding="async" src="../content/themes/streamit-theme/assets/images/redux/IMDB_Logo.svg" alt="imdb_logo"></span> -->
                                        </div>
                                        <div class="d-flex align-items-center">
                                          <span class="font-normal badge badge-secondary p-2 "> Action </span>
                                          <span class="font-normal ml-3"> 2hr : 20mins </span>
                                        </div>
                                      </div>
                                      ...
                                      <div class="trending-list RightAnimate-three">
                                        <div class="text-primary title genres"> Genres <span class="text-body">
                                            <a href="#">
                                              <span class="text-body">Sci-Fi</span>
                                            </a>
                                          </span>
                                        </div>
                                        <div class="text-primary title tag"> Tags <span class="text-body">
                                            <a href="#">
                                              <span class="text-body">Action</span>
                                            </a>, <a href="#">
                                              <span class="text-body">Assassin</span>
                                            </a>, <a href="#">
                                              <span class="text-body">Thriller</span>
                                            </a>
                                          </span>
                                        </div>
                                      </div>
                                      <div class="d-flex">
                                        <span class="d-flex mr-2 align-items-center r-mb-23 banner-view-btn bannerleft RightAnimate-four">
                                          <a href="{{ route('buymovie', ['id' => $images->id]) }}">
                                            <button type="button" class="btn btn-hover iq-button">
                                              <i class="fa fa-play mr-2" aria-hidden="true"></i> GET TICKETS </button>
                                          </a>
                                        </span>
                                        <span class="d-flex mr-2 align-items-center r-mb-23 banner-view-btn bannerleft RightAnimate-four">
                                          <button type="button" class="btn btn-hover iq-button " data-toggle="modal" data-target="#myModal">
                                            <i class="fa fa-play mr-2" aria-hidden="true"></i> BUY NOW </button>
                                        </span>
                                        <span class="d-lex  align-items-center r-mb-23 banner-view-btn right RightAnimate-four">
                                          <a href="" class="btn btn-hover iq-button">
                                            <i class="fa fa-play mr-2" aria-hidden="true"></i> VISIT OFFICAL SITE </a>
                                        </span>
                                      </div>
                                    </div>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <div class="modal-body">
                      <h4 class="modal-title text-center" id="exampleModalLabel">Kingdom of the Planet of the Apes </h4>
                      <p class="text-center">Select a retailer below to purchase. </p>
                      <div class="container">
                        <div class="row">
                          <div class="col-md-6 col-6">
                            <a target="_blank" href="https://www.primevideo.com/offers/nonprimehomepage/ref=dv_web_force_root">
                              <img id="imagelength" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Amazon_Prime_logo_%282024%29.svg/640px-Amazon_Prime_logo_%282024%29.svg.png"></img>
                            </a>
                          </div>
                          <div class="col-md-6 col-6">
                            <a target="_blank" href="https://www.hotstar.com/in/home?ref=%2Fin">
                              <img id="imagelength" src="https://play-lh.googleusercontent.com/MatnfBcuMybabLlOqSeIF-z1Ddu8diD2j404zrbmfBlLpZp7ACv6LS7QbA1dvzIjyvA=w240-h480-rw"></img>
                            </a>
                          </div>
                          <div class="col-md-6 col-6">
                            <a target="_blank" href="https://www.jiotv.com/">
                              <img id="imagelength" src="https://jep-asset.akamaized.net/jio/svg-og/jiotv_logo.png"></img>
                            </a>
                          </div>
                          <div class="col-md-6 col-6">
                            <a target="_blank" href="https://www.netflix.com/in/">
                              <img id="imagelength" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQGZhYUrmk6vDmi1-Pj7oI-HzTpQDCi9-IFTA&s"></img>
                            </a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="modal-footer">
                    <p class="text-center">The links above will take you directly to the retailer site to purchase. </p>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="elementor-widget-wrap elementor-element-populated">
                    ...
                    <div class="hf-elementor-layout elementor-element elementor-element-803ec8f elementor-widget__width-auto elementor-widget elementor-widget-heading" data-id="803ec8f" data-element_type="widget" data-widget_type="heading.default">
                      <div class="elementor-widget-container">
                        ...
                        <span class="elementor-heading-title elementor-size-default">Email us:</span>
                      </div>
                    </div>
                    <div class="hf-elementor-layout elementor-element elementor-element-322bdec elementor-widget__width-auto elementor-widget elementor-widget-heading" data-id="322bdec" data-element_type="widget" data-widget_type="heading.default">
                      <div class="elementor-widget-container">
                        <span class="elementor-heading-title elementor-size-default">customer@streamit.com</span>
                      </div>
                    </div>
                    <div class="hf-elementor-layout elementor-element elementor-element-bb45468 elementor-widget elementor-widget-heading" data-id="bb45468" data-element_type="widget" data-widget_type="heading.default">
                      <div class="elementor-widget-container">
                        <span class="elementor-heading-title elementor-size-default">costumer services</span>
                      </div>
                    </div>
                    <div class="hf-elementor-layout elementor-element elementor-element-1ed4ea2 elementor-widget elementor-widget-heading" data-id="1ed4ea2" data-element_type="widget" data-widget_type="heading.default">
                      <div class="elementor-widget-container">
                        <span class="elementor-heading-title elementor-size-default">+ (480) 555-0103</span>
                      </div>
                    </div>
                  </div>
                </div>
                              ...
                              <div class="menu-all-pages-container widget-menu-container">
                                <div class="menu-footer-quick-link-container">
                                  <ul id="menu-footer-quick-link" class="layout-footer-widget footer-menu">
                                    <li id="menu-item-17813" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-17813">
                                      <a href="#">About Us</a>
                                    </li>
                                    <li id="menu-item-17812" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-17812">
                                      <a href="#">Blog</a>
                                    </li>
                                    <li id="menu-item-20530" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-20530">
                                      <a href="#">Pricing Plan</a>
                                    </li>
                                    <li id="menu-item-17814" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-17814">
                                      <a href="#">FAQ</a>
                                    </li>
                                  </ul>
                                </div>
                              ...
                              <div class="menu-all-pages-container widget-menu-container">
                                <div class="menu-footer-movie-to-watch-container">
                                  <ul id="menu-footer-movie-to-watch" class="layout-footer-widget footer-menu">
                                    <li id="menu-item-18050" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-18050">
                                      <a href="#">Top Trending</a>
                                    </li>
                                    <li id="menu-item-18049" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-18049">
                                      <a href="#">Recommended</a>
                                    </li>
                                    <li id="menu-item-18048" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-18048">
                                      <a href="#">Popular</a>
                                    </li>
                                  </ul>
                                </div>
                              ...
                              <div class="menu-all-pages-container widget-menu-container">
                                <div class="menu-footer-about-company-container">
                                  <ul id="menu-footer-about-company" class="layout-footer-widget footer-menu">
                                    ...
                                    <li id="menu-item-17825" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-17825">
                                      <a href="#">Privacy Policy</a>
                                    </li>
                                    <li id="menu-item-17826" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-17826">
                      ...
                      <div class="elementor-widget-container">
                        <div class="iqonic-mailchimp-shortcode">
                          ...
                          <form id="mc4wp-form-1" class="mc4wp-form mc4wp-form-11311" method="post" data-id="11311" data-name="">
                            ...
                            <input type="hidden" name="_mc4wp_timestamp" value="1722505639" />
                            <input type="hidden" name="_mc4wp_form_id" value="11311" />
                        ...
                        <div class="elementor-column elementor-col-33 elementor-inner-column elementor-element elementor-element-aa30a3d layouts-column-align-inherit layouts-section-position-none" data-id="aa30a3d" data-element_type="column">
                          <div class="elementor-widget-wrap elementor-element-populated">
                            ...
                            <div class="hf-elementor-layout elementor-element elementor-element-c2e4646 elementor-widget elementor-widget-text-editor" data-id="c2e4646" data-element_type="widget" data-widget_type="text-editor.default">
                              <div class="elementor-widget-container"> © 2024 <span style="color: var(--iq-primary);">OTT</span>. All Rights Reserved. All videos and shows on this platform are trademarks of, and all related images and content are the property of, Streamit Inc. Duplication and copy of this is strictly prohibited. </div>
                            </div>
                          </div>
                        </div>
                                ...
                                <div class="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-0315cdf layouts-column-tablet-align-inherit layouts-column-align-inherit layouts-section-position-none" data-id="0315cdf" data-element_type="column">
                                  <div class="elementor-widget-wrap elementor-element-populated">
                                    <div class="hf-elementor-layout elementor-element elementor-element-c35967b elementor-widget elementor-widget-image" data-id="c35967b" data-element_type="widget" data-widget_type="image.default">
                                      <div class="elementor-widget-container">
                                        <img src="../content/uploads/2023/02/google-play.png" title="google-play" alt="image" loading="lazy" />
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                <div class="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-dbdf423 layouts-column-tablet-align-inherit layouts-column-align-inherit layouts-section-position-none" data-id="dbdf423" data-element_type="column">
                                  <div class="elementor-widget-wrap elementor-element-populated">
                                    <div class="hf-elementor-layout elementor-element elementor-element-1e8b8c0 elementor-widget elementor-widget-image" data-id="1e8b8c0" data-element_type="widget" data-widget_type="image.default">
                                      <div class="elementor-widget-container">
                                        <img src="../content/uploads/2023/02/apple.png" title="apple" alt="image" loading="lazy" />
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                          ...
                                          <div class="css_prefix-full-menu">
                                            <div class="menu-main-menu-container">
                                              <ul id="menu-main-menu" class="navbar-nav top-menu">
                                                <li id="menu-item-18557" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-18557">
    ...
    <link rel='stylesheet' id='woof_tooltip-css-noir-css' href='../content/plugins/woocommerce-products-filter/js/tooltip/css/plugins/tooltipster/sideTip/themes/tooltipster-sideTip-noir.min.css' type='text/css' media='all' />
