              ...
              window.location.href = redirect_url + app_name;
                                                    ...
                                                    <form id="loginform" action="{{route('register')}}" method="post">
                                                        ...
                                                        <p class="login-name">
                                                            ...
                                                            <input type="name" name="name" id="user_pass" autocomplete="current-name" spellcheck="false" class="input" value="" size="20"><i ></i>
                                                        </p>
                                                        
                                                        <p class="login-username">
                                                            <label for="user_login">Mobile</label>
                                                            <input type="text" name="mobile" id="user_login" autocomplete="mobile" class="input" value="" size="20">
                                                        </p>
                                                        <p class="login-username">
