                                            ...
                                            <div class="row mb-4">
                                                <div class="col-6">
                                                    <div data-mdb-input-init class="form-outline">
                                                        <label class="form-label" for="form6Example2">Trailer</label>
                                                        <input type="file" id="form6Example2" name="trailer" class="form-control" />
                                                        <input type="hidden" id="movietype" name="movietype" value="trailerdetails" class="form-control" />
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div data-mdb-input-init class="form-outline mb-4">
                                                        ...
                                                        <input type="file" id="form6Example4" name="movie" class="form-control" />
                                                    </div>
                                                    <!-- thumb nail -->
                                                </div>
